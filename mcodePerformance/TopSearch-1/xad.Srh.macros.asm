...
Write TREG[/*TREG_TCAM_RESULT_UNF_OFF*/ 80] , POLICY_RES_CONF_STR ,  TREG[CMP_BDOS_L23_SIP_OFF] , 16;

LookupAttackField IND_REG, 80 /*TREG_TCAM_RESULT_UNF_OFF , CMP_BDOS_L23_SIP_OFF*/,
...
Write TREG[/*TREG_TCAM_RESULT_UNF_OFF*/ 80] , POLICY_RES_CONF_STR ,  TREG[CMP_BDOS_L23_TOS_OFF] , CMP_BDOS_L23_TOS_SIZE;

LookupAttackField IND_REG, /* CMP_BDOS_L23_TOS_OFF , TREG_TCAM_RESULT_UNF_OFF */ 80,
...
Write TREG[/*TREG_TCAM_RESULT_UNF_OFF*/ 80] , POLICY_RES_CONF_STR ,  TREG[CMP_BDOS_L23_ID_NUM_OFF] , CMP_BDOS_L23_ID_NUM_SIZE;

LookupAttackField IND_REG, /* CMP_BDOS_L23_ID_NUM_OFF , TREG_TCAM_RESULT_UNF_OFF */ 80, 
...
Write TREG[/*TREG_TCAM_RESULT_UNF_OFF*/ 80] , POLICY_RES_CONF_STR ,  TREG[CMP_BDOS_L23_L4_PROT_OFF] , CMP_BDOS_L23_L4_PROT_SIZE;


//L4PROT_VALIDATION_BIT             		7
LookupAttackField IND_REG, /* CMP_BDOS_L23_L4_PROT_OFF , TREG_TCAM_RESULT_UNF_OFF */80, 
...
//#ifdef __comment__
Write TREG[/*TREG_TCAM_RESULT_UNF_OFF*/ 80] , POLICY_RES_CONF_STR ,  TREG[CMP_BDOS_L23_L3_SIZE_OFF] , CMP_BDOS_L23_L3_SIZE_SIZE;
 
LookupAttackField IND_REG, /* CMP_BDOS_L23_L3_SIZE_OFF , TREG_TCAM_RESULT_UNF_OFF */ 80  , 
...
LookupAttackField IND_REG, 80,
                  CMP_BDOS_L23_SIP_SIZE, IPV6_SIP_RES_POS, IPV6_SIP_RES_OFF, IPV6_SIP_VALIDATION_BIT, IPV6_SIP_FLD_TYP;
...
LookupAttackField IND_REG, CMP_BDOS_L23_DIP_OFF,
                  CMP_BDOS_L23_DIP_SIZE, IPV6_DIP_RES_POS, IPV6_DIP_RES_OFF, IPV6_DIP_VALIDATION_BIT, IPV6_DIP_FLD_TYP;
...
Write TREG[ 80 ] , POLICY_RES_CONF_STR ,  TREG[CMP_BDOS_L23_IPV6_TRAFFIC_CLASS_OFF] , CMP_BDOS_L23_IPV6_TRAFFIC_CLASS_SIZE;
...
Write TREG[ 80 ] , POLICY_RES_CONF_STR ,  TREG[CMP_BDOS_L23_IPV6_HOP_LIMIT_OFF] , CMP_BDOS_L23_IPV6_HOP_LIMIT_SIZE;
...
//#ifdef __comment__
Write TREG[80] , POLICY_RES_CONF_STR ,  TREG[{CMP_BDOS_L23_IPV6_FLOW_LABEL_OFF}] , 1 /*CMP_BDOS_L23_IPV6_FLOW_LABEL_SIZE*/;
Write TREG[81] , POLICY_RES_CONF_STR ,  TREG[{CMP_BDOS_L23_IPV6_FLOW_LABEL_OFF+1}] , 3 /*CMP_BDOS_L23_IPV6_FLOW_LABEL_SIZE*/;

//#ifdef __comment__
LookupAttackField IND_REG,  84,
...
TCP_SP_BDOS:
Write TREG[80 /* TREG_TCAM_RESULT_UNF_OFF */] , POLICY_RES_CONF_STR ,  TREG[CMP_BDOS_L4_SRC_PORT_OFF] , 2;
LookupAttackField IND_REG, /*CMP_BDOS_L4_SRC_PORT_OFF , TREG_TCAM_RESULT_UNF_OFF */80, 
